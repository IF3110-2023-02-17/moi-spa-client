...
const AuthWrapper = () => {
    ...
    return (
        ...
        <div className="auth-decor">
            <svg className="auth-shapes" viewBox="0 0 640 549" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="181.661" width="201.724" height="201.724" transform="rotate(12.5 181.661 0)" fill="#4362EA" />
                <mask id="mask0_0_1" maskUnits="userSpaceOnUse" x="0" y="-294" width="640" height="843">
